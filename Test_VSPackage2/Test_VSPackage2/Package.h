...
#include "..\Test_VSPackage2UI\CommandIds.h"
...
/***************************************************************************
CTest_VSPackage2Package handles the necessary registration for this package.

See EditorFactory.h for the details of the Editor key section in 
Test_VSPackage2.pkgdef.
...
The following Projects key section exists in Test_VSPackage2.pkgdef in order to
...
[$RootKey$\Projects\{A2FE74E1-B743-11d0-AE1A-00A0C90FFFC3}\AddItemTemplates\TemplateDirs\{1b61f494-19b2-4928-86fb-991db2ca8f2a}\/1]
@="#100"
"TemplatesDir"="$PackageFolder$\Templates"
"SortPriority"=dword:00004E20

The contents of Test_VSPackage2.vsdir, which is located a the location registered above are:
...
The meaning of the fields are as follows:
	...
	- {ab02f9cb-42e8-467c-a242-d9bb2e1918a0} - same as CLSID_Test_VSPackage2Package
	- #106 - the literal value of IDS_EDITOR_NAME in Test_VSPackage2UI.rc,
		which is displayed under the icon in the new file dialog.
	- 80 - the display ordering priority
	- #109 - the literal value of IDS_FILE_DESCRIPTION in Test_VSPackage2UI.rc, which is displayed
		in the description window in the new file dialog.
	- {ab02f9cb-42e8-467c-a242-d9bb2e1918a0} - resource dll package guid
	- 401 - the literal value of IDI_FILE_ICON in Test_VSPackage2.rc (not Test_VSPackage2UI.rc), 
	...
	- #107 - the literal value of IDS_DEFAULT_NAME in Test_VSPackage2UI.rc, which is the base
		name of the new files (i.e. myext1.myext, myext2.myext, etc.).

***************************************************************************/

//ControllerFactory g_ControllerFactory;

class ATL_NO_VTABLE CTest_VSPackage2Package : 
	...
	public CComCoClass<CTest_VSPackage2Package, &CLSID_Test_VSPackage2>,
	// Provides the implementation for IVsPackage to make this COM object into a VS Package.
	public IVsPackageImpl<CTest_VSPackage2Package, &CLSID_Test_VSPackage2>,
	public IOleCommandTargetImpl<CTest_VSPackage2Package>,
...
// the CTest_VSPackage2Package object will support via QueryInterface
BEGIN_COM_MAP(CTest_VSPackage2Package)
...
VSL_DECLARE_NOT_COPYABLE(CTest_VSPackage2Package)

public:
	CTest_VSPackage2Package():
		m_dwEditorCookie(0),
		m_MyToolWindow(GetVsSiteCache())
	{
      //g_ControllerFactory.SetVsSiteCache( GetVsSiteCache() );
	}
	...
	void PostSited(IVsPackageEnums::SetSiteResult /*result*/)
	{
		if(m_dwEditorCookie == 0) 
		{
			...
			CHKHR(spIVsRegisterEditors->RegisterEditor(CLSID_Test_VSPackage2EditorFactory, spIVsEditorFactory, &m_dwEditorCookie));
		}
	}
...
VSL_BEGIN_COMMAND_MAP()
    ...
    VSL_COMMAND_MAP_ENTRY(CLSID_Test_VSPackage2CmdSet, cmdidMyCommand, NULL, CommandHandler::ExecHandler(&OnMyCommand))
    VSL_COMMAND_MAP_ENTRY(CLSID_Test_VSPackage2CmdSet, cmdidMyTool, NULL, CommandHandler::ExecHandler(&OnMyTool))
...
void OnMyCommand(CommandHandler* /*pSender*/, DWORD /*flags*/, VARIANT* /*pIn*/, VARIANT* /*pOut*/)
{
	...
	//                             CLSID_NULL,
	//                             bstrTitle,
	//                             W2OLE(L"Queue Continous"),
 //                               W2OLE( L"So I was thinking right here the add-in would just queue an installer build :)" ),
	//                             0,
	//                             OLEMSGBUTTON_OK,
...
private:
    Test_VSPackage2ToolWindow m_MyToolWindow;

	// Cookie returned when registering editor
	VSCOOKIE m_dwEditorCookie;
};

// This exposes CTest_VSPackage2Package for instantiation via DllGetClassObject; however, an instance
// can not be created by CoCreateInstance, as CTest_VSPackage2Package is specifically registered with
// VS, not the the system in general.
OBJECT_ENTRY_AUTO(CLSID_Test_VSPackage2, CTest_VSPackage2Package)
