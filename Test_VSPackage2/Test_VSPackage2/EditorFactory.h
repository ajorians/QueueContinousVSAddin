...
/***************************************************************************
Test_VSPackage2.pkgdef contains:


[$RootKey$\Editors\{be259084-a5c9-46be-84f6-3ebdec9428c9}]
@="TestVSPackage2"
"Package"="{1b61f494-19b2-4928-86fb-991db2ca8f2a}"
"DisplayName"="TestVSPackage2"
"ExcludeDefTextEditor"=dword:00000001
"AcceptBinaryFiles"=dword:00000000

[$RootKey$\Editors\{be259084-a5c9-46be-84f6-3ebdec9428c9}\LogicalViews]
"{7651A703-06E5-11D1-8EBD-00A0C90F26EA}"=""

[$RootKey$\Editors\{be259084-a5c9-46be-84f6-3ebdec9428c9}\Extensions]
"test_vspackage2"=dword:00000032

which informs the shell that Test_VSPackage2Package is the package to create to have this editor 
registered with Visual Studio.  When Test_VSPackage2Package is sited by Visual Studio, 
Test_VSPackage2Package::PostSited creates an instance of EditorFactory and then queries
...
#pragma warning(pop)
		...
		VSEDITORCREATEDOCWIN& /*rCreateDocumentWindowUI*/)
	{
		if(physicalViewId == Primary)
		{
			...
			rpguidCommandUI = &CLSID_Test_VSPackage2EditorDocument;
