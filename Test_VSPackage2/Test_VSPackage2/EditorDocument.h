...
[$RootKey$\KeyBindingTables\{0f6d412c-7bbb-4a8b-8e06-ede7fcafc89f}]
@="#1"
...
Test_VSPackage2UI.vsct, to work correctly so that the appropriate command handler below will be
called.
...
class EditorDocument : 
	...
	public IDispatchImpl<ISingleViewEditor, &__uuidof(ISingleViewEditor), &LIBID_Test_VSPackage2Lib>,
...
VSL_BEGIN_COMMAND_MAP()
	...
	VSL_COMMAND_MAP_ENTRY(CLSID_Test_VSPackage2CmdSet, commandIDStrike, &OnQueryStrikeOut, &OnStrikeOut)
...
// Data members
	...
	VsMacroRecorder<&CLSID_Test_VSPackage2EditorDocument, LastMacro, eLastMacroNone> m_Recorder;
