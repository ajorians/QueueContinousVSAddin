...
[$RootKey$\KeyBindingTables\{0c5a7502-2469-446c-a50d-03e0842467f0}]
@="#1"
...
QueueContinousExtensionUI.vsct, to work correctly so that the appropriate command handler below will be
called.
...
class EditorDocument : 
	...
	public IDispatchImpl<ISingleViewEditor, &__uuidof(ISingleViewEditor), &LIBID_QueueContinousExtensionLib>,
...
VSL_BEGIN_COMMAND_MAP()
	...
	VSL_COMMAND_MAP_ENTRY(CLSID_QueueContinousExtensionCmdSet, commandIDStrike, &OnQueryStrikeOut, &OnStrikeOut)
...
// Data members
	...
	VsMacroRecorder<&CLSID_QueueContinousExtensionEditorDocument, LastMacro, eLastMacroNone> m_Recorder;
